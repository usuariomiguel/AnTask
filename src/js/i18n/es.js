...
export const es = {
  ...
  "header.empty":                "Sin tareas todavía",
  "header.all_done":             "Todo hecho",
  "header.pending_one":          "{n} pendiente",
  "header.pending_other":        "{n} pendientes",
  "header.overdue_one":          "{n} vencida",
  "header.overdue_other":        "{n} vencidas",
  "header.for_today":            "{n} para hoy",
  "header.next":                 "próxima: {date}",
  "header.left":                 "{n} sin hacer",
  "habits.today_of":             "{done} de {total} para hoy",
  "habits.none_today":           "Hoy no toca ninguno",
  "habits.best_streak_one":      "mejor racha {n} día",
  "habits.best_streak_other":    "mejor racha {n} días",
  ...
  "hoy.cal_expand":           "Ver el mes completo",
  "hoy.cal_collapse":         "Ver solo la semana",
  ...
  "habits.count_one":         "{count} hábito",
  "habits.count_other":       "{count} hábitos",
  "habits.other_days":        "Otros días",
  "habits.not_due":           "Hoy no toca",

  // ── Historial de hábitos ──────────────────────────────────
  "hist.title":               "Historial de hábitos",
  "hist.open":                "Ver historial",
  "hist.summary":             "{done} de {total} hábitos completados",
  "hist.pct":                 "{n}% de cumplimiento",
  "hist.perfect":             "{n} días perfectos",
  "hist.perfect_one":         "1 día perfecto",
  "hist.range_label":         "Periodo",
  "hist.range_7":             "7 días",
  "hist.range_30":            "30 días",
  "hist.range_90":            "90 días",
  "hist.range_todo":          "Todo",
  "hist.map_year":            "Último año",
  "hist.list_label":          "Hábitos",
  "hist.map_sr":              "Mapa del último año: {done} de {total} días cumplidos al completo.",
  "hist.less":                "Menos",
  "hist.more":                "Más",
  "hist.nothing_due":         "no tocaba nada",
  "hist.empty":               "Todavía no hay hábitos que seguir.",
  "hist.streak":              "Racha actual",
  "hist.per_habit":           "Por hábito",
  ...
  "chip.remove_important":   "Quitar importante",
  "chip.recur_label_one":     "Se repite cada día",
  "chip.recur_label_other":   "Se repite cada {n} días",
  "chip.go_to_list":          "Ir a la lista {name}",
  "brote.fecha":              "Añadir fecha",
  "brote.fecha_corto":        "+ fecha",
  "brote.recur":              "Añadir repetición",
  "brote.importante":         "Marcar como importante",
  "sugerencia.aplicar":       "Sugerido por el título: {label}. Pulsa para aplicarlo",
  "sugerencia.descartar":     "Descartar sugerencia",
  ...
  "notif.reminder_off":       "Las notificaciones están desactivadas, así que este recordatorio no te llegaría. ¿Las activas?",
  "notif.reminder_enable":    "Activar",
  "notif.reminder_blocked":   "El navegador tiene bloqueadas las notificaciones de AnTrack. Permítelas en los ajustes del sitio para recibir este recordatorio.",
  "notif.reminder_unsupported": "Este navegador no admite notificaciones, así que el recordatorio no podrá avisarte.",
