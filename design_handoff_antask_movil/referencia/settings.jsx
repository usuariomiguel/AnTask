...
function MobileSettings({ t, tw, setTweak, v1 }) {
  ...
  return (
    <div style={{ paddingBottom: 8 }}>
      ...
      <Card>
        ...
        {!v1 && <Row icon="sparkles" label="Plan" sub={isPro ? 'PRO · proyectos y notas ilimitados' : 'Gratis · \n3 proyectos, 10 notas'} right={isPro ? <SProBadge t={t} /> : <SUpgradeBtn t={t} compact />} />}
  ...
  const Section = () => {
    if (sec === 'cuenta') return (
      <React.Fragment>
        ...
        {!editingProfile && <>
          ...
          <SDRow t={t} label="Plan" desc={isPro ? 'PRO — proyectos y notas ilimitados, todas las apariencias y tareas recurrentes.' : 'Gratis — 3 proyectos, 10 notas y apariencias gratuitas.'}>
            {isPro ? <SProBadge t={t} /> : <SUpgradeBtn t={t} onClose={onClose} />}
          </SDRow>
    ...
    if (sec === 'tareas') return (
      <React.Fragment>
        ...
        <div style={{ height: 8 }} />
        <SDRow t={t} label="La semana empieza el lunes" desc="Afecta a las vistas Agenda y Mes.">
